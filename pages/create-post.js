...
// configure markdown editor to client-side import
...
export default function CreatePost() {
  ...
  useEffect(() => {
    setTimeout(() => {
      //delay rendering button until dynamic import is complete
      setLoaded(true);
    }, 500);
  }, []);
  ...
  async function createNewPost() {
    // saves posts to ipfs thens anchors to smart contract
